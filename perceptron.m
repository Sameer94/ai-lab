...
for k=1:100 #runnning percptron 100 times
sum_ein(k)=0;
ein=0;
	for i=1:training
...
sum_ein(k)=ein; #misclassification point in a iteration ein

sum_eout(k)=0;
eout=0;
 
	for i=1:remaining  # testing on data
...
sum_eout(k)= eout; #misclassification eout
